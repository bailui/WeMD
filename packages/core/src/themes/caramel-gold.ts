...
#wemd p {
    ...
    color: #5a4a3d; font-size: 16px; letter-spacing: 0.3px;
}

#wemd h1 { margin: 50px 0 36px; text-align: center; }
#wemd h1 .content {
    display: inline-block; font-size: 26px; font-weight: 700;
    color: #3d2008; padding-bottom: 16px; position: relative;
}
...
#wemd h2 .content {
    ...
    color: #fff; background: linear-gradient(135deg, #f59e0b, #fcd34d);
...
#wemd h3 .content {
    ...
    color: #b45309; padding: 4px 0 4px 14px;
...
#wemd h4 .content { font-size: 16px; font-weight: 600; color: #8a6a4a; }
#wemd h4 .content::before { content: "✦ "; color: #fcd34d; font-size: 12px; vertical-align: middle; }
#wemd h4 .prefix, #wemd h4 .suffix { display: none; }

#wemd .multiquote-1 {
    margin: 28px 0; padding: 20px 24px;
    background: #fffdf5; border-left: 4px solid #fcd34d;
    border-radius: 0 16px 16px 0;
    box-shadow: 0 2px 16px rgba(0,0,0,0.04);
}
#wemd .multiquote-1 p { color: #5a4a3d; font-size: 15px; }
#wemd .multiquote-2 {
    margin: 24px 0; padding: 16px 20px;
    background: #fffdf5; border-left: 3px solid #fcd34d;
    border-radius: 0 12px 12px 0;
}
#wemd .multiquote-2 p { color: #5a4a3d; font-size: 14px; }
#wemd .multiquote-3 {
    margin: 22px 0; padding: 14px 18px;
    background: #fffdf0; border-left: 2px solid #fef3c7;
    border-radius: 0 10px 10px 0;
}
#wemd .multiquote-3 p { color: #5a4a3d; font-size: 14px; }

#wemd ul, #wemd ol { margin: 22px 0; padding-left: 24px; }
#wemd ul { list-style-type: disc; } #wemd ol { list-style-type: decimal; }
#wemd li section { margin: 8px 0; color: #5a4a3d; line-height: 1.8; }
#wemd ul li::marker, #wemd ol li::marker { color: #f59e0b; }
#wemd ul ul li::marker, #wemd ol ol li::marker { color: #fcd34d; }

#wemd a { color: #f59e0b; text-decoration: none; border-bottom: 1.5px solid #fef3c7; }
...
#wemd mark { background: #fef3c7; color: #92400e; padding: 2px 6px; border-radius: 3px; }
...
#wemd pre code.hljs {
    display: block; padding: 20px; background: #2d2010;
...
#wemd pre code:not(.hljs) {
    color: #e0d0b8; background: #2d2010;
    border-radius: 16px; border: 1px solid rgba(245,158,11,0.2);
}

#wemd img { display: block; margin: 24px auto; max-width: 100%; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); }
#wemd figcaption { margin-top: 10px; text-align: center; color: #c0b090; font-size: 13px; }
...
#wemd table tr th {
    background: #fffdf0; color: #5a4a3d;
    padding: 14px 16px; font-weight: 600; text-align: left;
    border-bottom: 2px solid #fef3c7;
}
#wemd table tr td {
    padding: 14px 16px; color: #5a4a3d;
    border-bottom: 1px solid #fef3c7; background: #fff;
}
#wemd table tr:last-child td { border-bottom: none; }

#wemd .footnote-word, #wemd .footnote-ref { color: #f59e0b; }
#wemd .footnotes-sep { border-top: 1px solid #fef3c7; padding-top: 20px; margin-top: 40px; font-size: 12px; color: #c0b090; }
#wemd .footnote-num { font-weight: 600; color: #f59e0b; margin-right: 4px; font-size: 11px; }
#wemd .footnote-item p { color: #c0b090; font-size: 12px; margin: 4px 0; }
...
#wemd .callout { margin: 28px 0; padding: 20px 24px; background: #fffdf5; border-radius: 16px; border: 1px solid #fef3c7; }
#wemd .callout-title { font-weight: 600; color: #f59e0b; margin-bottom: 8px; }
#wemd .callout-note { border-left: 4px solid #f59e0b; }
#wemd .callout-tip { border-left: 4px solid #fcd34d; }
#wemd .callout-important { border-left: 4px solid #f59e0b; }
