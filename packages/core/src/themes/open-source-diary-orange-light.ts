export const openSourceDiaryOrangeLightTheme = `/* WeMD Theme: 开源日记 · 橙 · 亮 */
#wemd {
    padding: 36px 26px;
    max-width: 677px;
    margin: 0 auto;
...
#wemd mark { background: rgba(249,115,22,0.06); color: #F97316; padding: 2px 8px; border-radius: 4px; border: 1px solid rgba(249,115,22,0.08); }
...
#wemd pre code:not(.hljs) { color: #4a4a50; background: #f8f5f0; border-radius: 8px; border: 1px solid #e8e0d8; }
...
#wemd hr { margin: 40px auto; border: none; height: 1px; width: 100%; background: #e0d8d0; position: relative; }
#wemd hr::after { content: "\u00a7"; position: absolute; top: -14px; left: 50%; transform: translateX(-50%); color: #d0c8c0; font-size: 18px; font-family: Georgia, serif; background: #fdfaf7; padding: 0 8px; }

#wemd table { width: 100%; border-collapse: collapse; margin: 26px 0; font-size: 14px; border: 1px solid #e8e0d8; border-radius: 6px; overflow: hidden; }
#wemd table tr th { background: #f8f5f0; color: #3a3a42; padding: 14px 18px; font-weight: 600; text-align: left; border-bottom: 1px solid #ddd; font-family: "STSong", "Songti SC", "Noto Serif SC", "Source Han Serif SC", Georgia, serif; letter-spacing: 1.2px; }
...
#wemd .footnote-word, #wemd .footnote-ref { color: #F97316; }
#wemd .footnotes-sep { border-top: 1px solid #e8e0d8; padding-top: 22px; margin-top: 40px; font-size: 12px; color: #bbb; letter-spacing: 1.2px; }
#wemd .footnote-num { font-weight: 600; color: #F97316; margin-right: 6px; font-size: 11px; opacity: 0.6; }
...
#wemd .callout { margin: 26px 0; padding: 18px 22px; background: #fdfaf7; border-radius: 6px; border: 1px solid #e8e0d8; }
...
#wemd .callout-warning .callout-title { color: #EA580C; }
