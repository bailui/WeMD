...
#wemd p {
    ...
    color: #5a3a3a; font-size: 16px; letter-spacing: 0.3px;
}

#wemd h1 { margin: 50px 0 36px; text-align: center; }
#wemd h1 .content {
    display: inline-block; font-size: 26px; font-weight: 700;
    color: #3d1010; padding-bottom: 16px; position: relative;
}
#wemd h1 .content::after {
    content: ""; position: absolute; bottom: 0; left: 50%;
    transform: translateX(-50%); width: 60px; height: 3px;
    background: linear-gradient(90deg, #ea68b6, #aa1141, #ea68b6);
    border-radius: 2px;
}
...
#wemd h2 .content {
    ...
    color: #fff; background: linear-gradient(135deg, #b41919, #ea68b6);
...
#wemd h3 .content {
    ...
    color: #aa1141; padding: 4px 0 4px 14px;
    border-left: 4px solid #aa1141; border-radius: 0 4px 4px 0;
}
#wemd h3 .prefix, #wemd h3 .suffix { display: none; }

#wemd h4 { margin: 24px 0 12px; }
#wemd h4 .content { font-size: 16px; font-weight: 600; color: #8a4a5a; }
#wemd h4 .content::before { content: "✦ "; color: #ea68b6; font-size: 12px; vertical-align: middle; }
#wemd h4 .prefix, #wemd h4 .suffix { display: none; }

#wemd .multiquote-1 {
    margin: 28px 0; padding: 20px 24px;
    background: #fff5f5; border-left: 4px solid #ffa6a6;
    border-radius: 0 16px 16px 0;
    box-shadow: 0 2px 16px rgba(0,0,0,0.04);
}
#wemd .multiquote-1 p { color: #5a3a3a; font-size: 15px; }
#wemd .multiquote-2 {
    margin: 24px 0; padding: 16px 20px;
    background: #fff5f5; border-left: 3px solid #ea68b6;
    border-radius: 0 12px 12px 0;
}
#wemd .multiquote-2 p { color: #5a3a3a; font-size: 14px; }
#wemd .multiquote-3 {
    margin: 22px 0; padding: 14px 18px;
    background: #ffeef0; border-left: 2px solid #ffc0d0;
    border-radius: 0 10px 10px 0;
}
#wemd .multiquote-3 p { color: #5a3a3a; font-size: 14px; }

#wemd ul, #wemd ol { margin: 22px 0; padding-left: 24px; }
#wemd ul { list-style-type: disc; } #wemd ol { list-style-type: decimal; }
#wemd li section { margin: 8px 0; color: #5a3a3a; line-height: 1.8; }
#wemd ul li::marker, #wemd ol li::marker { color: #aa1141; }
#wemd ul ul li::marker, #wemd ol ol li::marker { color: #ffa6a6; }

#wemd a { color: #aa1141; text-decoration: none; border-bottom: 1.5px solid #ffc0d0; }
...
#wemd mark { background: #ffc0d0; color: #aa1141; padding: 2px 6px; border-radius: 3px; }
#wemd del { text-decoration: line-through; color: #c09098; }

#wemd p code, #wemd li code {
    color: #9a0000; background: #ffeef0;
...
#wemd pre code.hljs {
    display: block; padding: 20px; background: #2d1518;
    border-radius: 16px; font-size: 13px; line-height: 1.6;
    font-family: "SF Mono", "Consolas", "Monaco", monospace;
    overflow-x: auto; white-space: pre; min-width: max-content;
    border: 1px solid rgba(170,17,65,0.2);
    box-shadow: 0 4px 20px rgba(0,0,0,0.06);
}
#wemd pre code:not(.hljs) {
    color: #e0b8c0; background: #2d1518;
    border-radius: 16px; border: 1px solid rgba(170,17,65,0.2);
}

#wemd img { display: block; margin: 24px auto; max-width: 100%; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); }
#wemd figcaption { margin-top: 10px; text-align: center; color: #c09098; font-size: 13px; }

#wemd hr {
    margin: 40px auto; border: none; height: 2px; width: 50%;
    background: linear-gradient(90deg, transparent, #ffc0d0, transparent);
    border-radius: 1px;
}
...
#wemd table tr th {
    background: #ffeef0; color: #5a3a3a;
    padding: 14px 16px; font-weight: 600; text-align: left;
    border-bottom: 2px solid #ffc0d0;
}
#wemd table tr td {
    padding: 14px 16px; color: #5a3a3a;
    border-bottom: 1px solid #ffc0d0; background: #fff;
}
#wemd table tr:last-child td { border-bottom: none; }

#wemd .footnote-word, #wemd .footnote-ref { color: #aa1141; }
#wemd .footnotes-sep { border-top: 1px solid #ffc0d0; padding-top: 20px; margin-top: 40px; font-size: 12px; color: #c09098; }
#wemd .footnote-num { font-weight: 600; color: #aa1141; margin-right: 4px; font-size: 11px; }
#wemd .footnote-item p { color: #c09098; font-size: 12px; margin: 4px 0; }
...
#wemd .callout { margin: 28px 0; padding: 20px 24px; background: #fff5f5; border-radius: 16px; border: 1px solid #ffc0d0; }
#wemd .callout-title { font-weight: 600; color: #aa1141; margin-bottom: 8px; }
#wemd .callout-note { border-left: 4px solid #aa1141; }
#wemd .callout-tip { border-left: 4px solid #ea68b6; }
#wemd .callout-important { border-left: 4px solid #aa1141; }
